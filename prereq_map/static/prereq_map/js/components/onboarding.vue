        ...
        <div class="modal-content">
          <div class="modal-header">
            <button
              ...
              data-dismiss="modal"
              aria-label="Close"
              v-on:click="$ga.event('onboarding', 'click', 'close button')"
            >
            ...
            <div id="carouselExampleIndicators" class="carousel slide">
              ...
              <div class="carousel-inner rounded-lg">
                ...
                >
                  ...
                  >Discover courses and plan your schedule more effectively</h2>
                  <p>
                    It can be tough figuring out which courses to take. How do you find courses similar to ones you’ve really enjoyed? Of the courses you’ve already taken, which ones provide a foundation for more advanced coursework? What sequence of courses is best? The
                    <strong>Prereq Map</strong> helps you discover interesting courses and enables you to be strategic about planning your course schedule. (What’s a prereq? Prereq is short for prerequisites: the courses that act as a foundation for other courses.)
                  </p>
                ...
                <div class="carousel-item">
                  <img
                    ...
                    style="width:600px; border:solid 2px #333;"
                  >
                ...
                <div class="carousel-item">
                  <img
                    ...
                    style="width:600px; border:solid 2px #333;"
                  >
                  <h2 class="mt-4 mb-4 h3">Get additional info about a course</h2>
                ...
                <div class="carousel-item">
                  <img
                    ...
                    style="width:600px; border:solid 2px #333;"
                  >
                  <h2 class="mt-4 mb-4 h3">Get more course detail and find related curricula</h2>
                  ...
                  <ul>
                    <li>Prereq Map shows current prerequisites. When planning several quarters out, keep in mind that prerequisites may change over time.</li>
                    <li>Prereq Map is based solely on course prerequisites and does not take into account specific requirements for graduation.</li>
                    <li>Not all equivalencies (e.g. placement tests) are represented in the map – just courses. You can find some equivalencies in the text description.</li>
                    <li>Remember to talk to your adviser when course planning.</li>
                  </ul>
                  ...
                  <div class="text-center mt-3">
                    <div>
                      <a
                        ...
                        v-on:click="$ga.event('outbound', 'click', 'https://itconnect.uw.edu/learn/tools/prereq-map/')"
                        target="_blank"
